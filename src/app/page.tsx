    ...
    <div className="stage-shell">
      <div className="stage-content portal-stage flex min-h-screen items-center justify-center">
        <div className="quiz-panel px-6 py-5 text-center">
          <p className="text-white/70">퀴즈를 준비하는 중...</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="mx-auto flex w-full max-w-[1380px] flex-col gap-6">
          ...
          <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr] xl:gap-8">
            <div className="flex flex-col gap-4 lg:h-full">
              <section className="quiz-panel flex flex-col gap-8 p-6 sm:p-8 lg:flex-1 lg:p-10">
              ...
              <section className="quiz-panel flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
                <div>
            ...
            <section className="paper-panel p-6 sm:p-8 lg:h-full">
              <div className="flex h-full flex-col gap-5">
                ...
                <div className="paper-purple-bg mt-auto flex items-center gap-4 rounded-[24px] p-4 text-sm font-bold sm:p-5">
